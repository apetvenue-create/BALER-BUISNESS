...
export const TRANSLATIONS: Record<Language, Translation> = {
  en: {
    ...
    labourWageLabel: "Wage (₹)",
    labourTotalGivenLabel: "Total Paid to Labour",
    addWageBtn: "+ Add Wage",
    labourLedgerTitle: "Payment Ledger",
    errLabourWageNotSet: "Set wage amount on this account first.",
    errPhoneTenDigits: "Phone number must be exactly 10 digits.",
    ...
    machineRepairOption: "Machine Repair",
    statsMachineRepairExpense: "Machine Repair",
    newMachineryOption: "New Machinery",
    otherRepairOption: "Other Repair",
    statsNewMachineryExpense: "New Machinery",
    statsOtherRepairExpense: "Other Repair",
  ...
  hi: {
    ...
    labourWageLabel: "वेतन (₹)",
    labourTotalGivenLabel: "मजदूर को कुल दिया",
    addWageBtn: "+ वेतन जोड़ें",
    labourLedgerTitle: "भुगतान खाता",
    errLabourWageNotSet: "पहले इस खाते पर वेतन राशि सेट करें।",
    errPhoneTenDigits: "फ़ोन नंबर ठीक 10 अंकों का होना चाहिए।",
    ...
    machineRepairOption: "मशीन मरम्मत",
    statsMachineRepairExpense: "मशीन मरम्मत",
    newMachineryOption: "नई मशीनरी",
    otherRepairOption: "अन्य मरम्मत",
    statsNewMachineryExpense: "नई मशीनरी",
    statsOtherRepairExpense: "अन्य मरम्मत",
  ...
  pa: {
    ...
    labourWageLabel: "ਵੇਤਨ (₹)",
    labourTotalGivenLabel: "ਮਜ਼ਦੂਰ ਨੂੰ ਕੁੱਲ ਦਿੱਤਾ",
    addWageBtn: "+ ਵੇਤਨ ਜੋੜੋ",
    labourLedgerTitle: "ਭੁਗਤਾਨ ਲੇਜ਼ਰ",
    errLabourWageNotSet: "ਪਹਿਲਾਂ ਇਸ ਖਾਤੇ ਤੇ ਵੇਤਨ ਰਕਮ ਸੈੱਟ ਕਰੋ।",
    errPhoneTenDigits: "ਫ਼ੋਨ ਨੰਬਰ ਬਿਲਕੁਲ 10 ਅੰਕਾਂ ਦਾ ਹੋਣਾ ਚਾਹੀਦਾ ਹੈ।",
    ...
    machineRepairOption: "ਮਸ਼ੀਨ ਮੁਰੰਮਤ",
    statsMachineRepairExpense: "ਮਸ਼ੀਨ ਮੁਰੰਮਤ",
    newMachineryOption: "ਨਵੀਂ ਮਸ਼ੀਨਰੀ",
    otherRepairOption: "ਹੋਰ ਮੁਰੰਮਤ",
    statsNewMachineryExpense: "ਨਵੀਂ ਮਸ਼ੀਨਰੀ",
    statsOtherRepairExpense: "ਹੋਰ ਮੁਰੰਮਤ",
